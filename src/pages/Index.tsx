      ...
      <div style={{
        ...
        <header style={{
          ...
          <div style={{
            ...
            <button onClick={() => setOpen(true)}
              ...
              <kbd className="velo-hide-mobile" style={{
                fontSize: T.cardMeta, fontFamily: "monospace",
          ...
          <div style={{
            ...
            <UserMenu navLinkSize={T.navLink} />
        ...
        <main style={{
          ...
          <div style={{
            ...
            {/* Pill */}
            <div style={{
              ...fadeUp(0), display: "inline-flex", alignItems: "center",
            ...
            {/* Título */}
            <h1 style={{
              ...fadeUp(80), fontSize: T.heroTitle,
            ...
            <div style={{
              ...
              {[
                ...
                <div key={l} style={{ textAlign: "center" }}>
                  ...
                  <div style={{
                    fontSize: T.statLabel, color: "hsl(240 4% 38%)",
          ...
          <div aria-hidden style={{
            width: "100%", maxWidth: "clamp(300px,80vw,900px)",
          ...
          {rootModules.length > 0 && (
            <section style={{ width: "100%", maxWidth: "clamp(300px,80vw,920px)" }}>
              ...
              {/* Label da seção */}
              <p style={{
                fontSize: T.sectionLbl, fontWeight: 700,
                  ...
                  return (
                    <Link key={mod.id} to={href} className="velo-card"
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <p style={{
                          fontSize: T.cardTitle, fontWeight: 600,
                        ...
                        {(mod as any).description && (
                          <p style={{
                            fontSize: T.cardDesc, color: "hsl(240 4% 50%)",
                            marginBottom: ".35rem",
                            overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap"
                          }}>
                            {(mod as any).description}
                      ...
                      <ChevronRight className="velo-arrow"
                        style={{
                          width: "clamp(14px,1.2vw,18px)", height: "clamp(14px,1.2vw,18px)",
              ...
              <div className="velo-feats" style={{
                ...
                {[
                  ...
                  { Icon: ArrowRight, bg: "rgba(251,146,60,.16)", c: "#fb923c", t: "Acesso rápido", d: "Diagnósticos e Academia integrados" },].map(({ Icon, bg, c, t, d }) => (
                    <div key={t} className="velo-feat"
                      ...
                      <p style={{
                        fontSize: T.featTitle, fontWeight: 500,
                        color: "hsl(0 0% 88%)", marginBottom: ".2rem"
                      }}>{t}</p>
        ...
        <footer style={{
          ...
          <Link
            to="/_olev-9f3k2"
            style={{
              color: "hsl(240 4% 22%)", textDecoration: "none", opacity: .45,
              fontSize: "clamp(0.6rem,0.55rem+0.2vw,0.72rem)",
